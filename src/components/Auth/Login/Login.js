        ...
        <div className='Signup-Page'>
            ...
            <div className='middle-portion'>
                ...
                <form className="bg-white p-8 rounded-lg shadow-md w-full max-w-md" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <p className="text-red-600 cursor-pointer mb-4" onClick={handleClick}>
                        <u>Forgot password?</u>
                    </p>
                    <button className="w-full bg-red-500 text-white py-2 rounded-md hover:bg-red-600 transition duration-200" type="submit">
                        Login
                    </button>
                    <p className='text-xl mb-2 text-red-400'>{authError}</p>
                    <p className="mt-4 text-center text-gray-600">
                        Create New Account <span className="text-red-600 cursor-pointer" onClick={handleClicked}>Signup</span>
                    </p>
                </form>
            </div>
